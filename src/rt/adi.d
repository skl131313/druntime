...
extern (C) export char[] _adReverseChar(char[] a)
{
    if (a.length > 1)
    {
        char[6] tmp;
...
extern (C) export wchar[] _adReverseWchar(wchar[] a)
{
    if (a.length > 1)
    {
        wchar[2] tmplo = void;
...
extern (C) export void[] _adReverse(void[] a, size_t szelem)
out (result)
{
    assert(result is a);
}
...
extern (C) export int _adCmp(void[] a1, void[] a2, TypeInfo ti)
{
...
extern (C) export int _adCmp2(void[] a1, void[] a2, TypeInfo ti)
{
...
extern (C) export int _adCmpChar(void[] a1, void[] a2)
{
